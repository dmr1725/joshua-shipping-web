...
export const OrderList: React.FC<OrdersProps> = ({ orders, renderDetails, orderType, rootRoute }) => {
    return (
        <div className={styles['orders-container']}>
            {orders.map((order) => {
                const orderLink = `/${rootRoute}/${orderType}/${order.id}`; // Generate order link (adjust for dispatch if needed)
